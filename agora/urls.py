...
urlpatterns = [
    ...
    path('itens/<int:course_item_id>/forum/excluir/', delete_forum_view, name='delete_forum'),
    path('forum/mensagens/<int:message_id>/excluir/', delete_forum_message_view, name='delete_forum_message'),
